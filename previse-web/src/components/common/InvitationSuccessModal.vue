    ...
    <div class="fixed inset-0 z-[95] bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in">
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-lg w-full border border-gray-200 dark:border-gray-700 animate-scale-in">
        ...
        <div class="px-6 py-5 text-center border-b border-gray-200 dark:border-gray-700">
          ...
          <p v-if="props.isExistingUser" class="mt-2 text-xs inline-flex items-center gap-1 px-2 py-1 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300">
            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
            </svg>
            Létező felhasználó - a jelenlegi jelszavával fog belépni
          </p>
        </div>
          ...
          <div class="p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
            <div class="flex items-start gap-2">
              ...
              <div class="text-xs text-amber-800 dark:text-amber-200">
                ...
                <p>Az email szerver még nincs konfigurálva, ezért a meghívó email nem került kiküldésre. Másold ki a linket, és küldd el kézzel, vagy teszteld másik böngészőben / inkognitó ablakban.</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div class="flex gap-2">
              <input
                ...
                readonly
                class="flex-1 px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white font-mono text-xs"
